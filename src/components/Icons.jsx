...
const PATHS = {
  ...
  chat: (
    <>
      <path d="M20.5 12.5c0 4-3.8 7-8.5 7-1 0-2-.15-2.9-.4L4 20.5l1.3-3.6c-1.1-1.2-1.8-2.7-1.8-4.4 0-4 3.8-7 8.5-7s8.5 3 8.5 7Z" />
      <path d="M8.8 12h.01M12 12h.01M15.2 12h.01" />
    </>
  ),
  sparkle: (
    <>
      <path d="M11 3.5 12.7 8l4.5 1.7-4.5 1.7L11 16l-1.7-4.6-4.5-1.7L9.3 8 11 3.5Z" />
      <path d="M18 14.5l.8 2.2 2.2.8-2.2.8-.8 2.2-.8-2.2-2.2-.8 2.2-.8.8-2.2Z" />
    </>
  ),
  send: <path d="M4.5 12 20 4.5l-5 15.5-3.5-6.5L4.5 12Z" />,
  guide: (
    <>
